...
import { type DeckSlot, type LiquidHandlerConfig } from '../data/liquidHandler'
...
export default function MaterialPanel({ config, error }: MaterialPanelProps): JSX.Element {
...
// 选中槽位的详情展示
function SlotDetail({ slot }: SlotDetailProps): JSX.Element {
  if (!slot.labware) {
